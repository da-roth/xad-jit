...
// Scalar ops - these involve a constant
template <class S, class T> struct JITOpCodeFor<scalar_add_op<S, T>> { static constexpr bool known = true; static constexpr JITOpCode value = JITOpCode::Add; static constexpr bool hasConstant = true; };
template <class S, class T> struct JITOpCodeFor<scalar_sub1_op<S, T>> { static constexpr bool known = true; static constexpr JITOpCode value = JITOpCode::Sub; static constexpr bool hasConstant = true; };
template <class S, class T> struct JITOpCodeFor<scalar_sub2_op<S, T>> { static constexpr bool known = true; static constexpr JITOpCode value = JITOpCode::Sub; static constexpr bool hasConstant = true; };
template <class S, class T> struct JITOpCodeFor<scalar_prod_op<S, T>> { static constexpr bool known = true; static constexpr JITOpCode value = JITOpCode::Mul; static constexpr bool hasConstant = true; };
template <class S, class T> struct JITOpCodeFor<scalar_div1_op<S, T>> { static constexpr bool known = true; static constexpr JITOpCode value = JITOpCode::Div; static constexpr bool hasConstant = true; };
template <class S, class T> struct JITOpCodeFor<scalar_div2_op<S, T>> { static constexpr bool known = true; static constexpr JITOpCode value = JITOpCode::Div; static constexpr bool hasConstant = true; };
template <class S, class T> struct JITOpCodeFor<scalar_pow1_op<S, T>> { static constexpr bool known = true; static constexpr JITOpCode value = JITOpCode::Pow; static constexpr bool hasConstant = true; };
template <class S, class T> struct JITOpCodeFor<scalar_pow2_op<S, T>> { static constexpr bool known = true; static constexpr JITOpCode value = JITOpCode::Pow; static constexpr bool hasConstant = true; };
